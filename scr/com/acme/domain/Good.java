...
public abstract class Good implements Product {
    ...
    static {
        ...
        Solid balloon = new Solid("Acme Balloon", 1401, 15,UnitOfMeasureType.CUBIC_FOOT, false, 10, 5, 5);
        Solid pistol = new Solid("Acme Disintegrating Pistol", 1587, 0.1,UnitOfMeasureType.CUBIC_FOOT, false, 1, 0.5, 2);
